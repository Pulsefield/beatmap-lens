...
now has a newer task. Read the [shared workflow](../../docs/annotation/agent-workflow.md) and
[expert guide](../../.agents/skills/mania-pattern-judgment/references/judgment-guide.md).
