...
SCRIPT = Path(__file__).resolve().parent.parent.joinpath("annotation-queries.py")
...
fixture = json.loads((SCRIPT.resolve().parents[1] / "scripts/fixtures").joinpath("pattern-queries-reviewed.json").read_text())
